...
export const authFooterLinkClass = "-my-2.5 inline-block py-2.5 font-medium text-nx-text underline underline-offset-4 decoration-nx-border hover:decoration-nx-text focus-visible:rounded focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-nx-accent";
