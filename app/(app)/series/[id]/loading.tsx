const SeriesLoading = () => (
    <div className="min-h-dvh bg-nx-bg" aria-label="Ładowanie strony serialu" aria-busy="true">
        <div className="min-h-[58vh] skeleton-pulse" />
        <div className="mx-auto grid max-w-360 grid-cols-4 gap-5 px-5 py-10 sm:px-8 lg:grid-cols-12 lg:px-10">
